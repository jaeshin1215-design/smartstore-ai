...
// 김중만 사진 매핑
const MONTH_PHOTO: Record<number, string | null> = {
  1:  "3.jpg",  2:  "2.jpg",  3:  "6.jpg",
  4:  "4.png",  5:  "5.jpg",  6:  "1.jpg",
  7:  "7.jpg",  8:  "8.jpg",  9:  "9.png",
  10: "11.png", 11: "10.png", 12: "12.jpg",
};
          ...
          <div style={{
            ...
            {visible.map(month => {
              ...
              return (
                ...
                >
                  {/* ── 컬러필드 (4/3, 사진 or 시즌 배경, 좌하단 영문 세리프) ── */}
                  <div style={{
                    aspectRatio: "4 / 3",
                    backgroundColor: SEASON_BG[mSeason],
                    backgroundImage: MONTH_PHOTO[month] ? `url(/images/calendar/${MONTH_PHOTO[month]})` : "none",
                        ...
                        {targets.map(({ brand }) => {
                          ...
                          return (
                            <div key={brand.id} style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                              ...
                              <span style={{ fontSize: "14px", color: COLOR_SUB, fontFamily: FONT_BODY, lineHeight: 1 }}>
