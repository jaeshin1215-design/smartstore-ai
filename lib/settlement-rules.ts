...
//   오포_카노위탁 추가(2026-07-27 박혜미 프로 확정): "오포/오포(카노)는 모두 당사 물류".
//   근거 보강 — 배송비 기준표(★배송비★.xlsx)에서 오포_카노위탁 14건 전부 [오포물류] 시트에 존재.
//   ※ 이 변경으로 이다슬 195건 상품총원가 합계가 +410.36원(기준 변경, 오류 아님. 박혜미 안내 완료).
export const CROSS_LOGISTICS = ["오포물류", "유비엘", "오포_카노위탁"] as const;
